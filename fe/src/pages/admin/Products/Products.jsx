                ...
                <div className="card-body">
                    <form onSubmit={submitProduct} encType="multipart/form-data">
                        <div className="tab-content" id="myTabContent" >
                            <div className="tab-pane card-body border fade show active" style={{ display: 'flex' }} id="home" role="tabpanel" aria-labelledby="home-tab">
                                <div className="col-6">
                                ...
                                <div className="col-6">
                                    ...
                                    <div className="col-md-8 form-group mb-3">
                                        <label>Image01</label>
                                        <input type="file" name="image01" onChange={handleChange} className="form-control" />
                                    ...
                                    <div className="col-md-8 form-group mb-3">
                                        <label>Image02</label>
                                        <input type="file" name="image02" onChange={handleImage1} className="form-control" />
                                            ...
                                            sizelist.map((item) => {
                                                ...
                                                return (
                                                    <div className="form-group" style={{marginRight: '15px'}}>
                                                        ...
                                                        <input type="checkbox" name='sizes[]' class="btn-check btn-checkTest" id={item.id+item.name} autocomplete="off" />
                                                        <label class="btn btn-outline-primary" for={item.id+item.name}>{item.name}</label>
                                                    </div>
                                                )
                                            })
                                        }
                                    ...
                                    <div style={{display: 'flex', marginLeft:'15px'}}> 
                                        {
                                            colorlist.map((item) => {
                                                ...
                                                return (
                                                    <div className="form-group" style={{marginRight: '15px'}}>
                                                        <input type="checkbox" class="btn-check btn-checkTest" id={item.id+item.name} autocomplete="off" />
                                                        <label class="btn btn-outline-primary" for={item.id+item.name}>{item.name}</label>
                                                    </div>
                                                )
                                            })
