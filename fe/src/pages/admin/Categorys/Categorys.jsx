                ...
                this.state.Categorys.map((item) => {
                    return (
                        <tr key={item.id}>
                            ...
                            <td>{item.name}</td>
                            <td>
                                <a className="btn btn-success btn-sm" href={`edit-category/${item.id}`}>Edit</a>
                                <a className="btn btn-danger btn-sm" onClick={(e)=> this.deleteCategory(e,item.id)}> | Delete</a>
                            </td>
                        </tr>
                    );
                });
                        ...
                        <div className="col-md-12">
                            <div className="card">
                                <div className="card-header" style={{ display: "flex", justifyContent: "space-between" }}>
                                    ...
                                    <a className="btn btn-primary" href="/AddCategory">Add Category</a>
                                </div>
