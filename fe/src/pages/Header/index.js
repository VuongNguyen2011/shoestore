                  ...
                  <div class="col-md-4 pt-5">
                    <img class="logo" src={require("../../images/logo.png")} alt=""></img>
                      <ul class="list-unstyled text-light footer-link-list">
                          <li>
                              <i class="fas fa-map-marker-alt fa-fw" style={{color: "#000000"}}></i>
                              <b style={{color: "#000000"}}>Viet Nam</b>
                          </li>
                          <li>
                              <i class="fa fa-phone fa-fw" style={{color: "#000000"}}></i>
                              <b class="text-decoration-none" style={{color: "#000000"}}href="#">0898 515 689</b>
                          </li>
                          <li>
                              <i class="fa fa-envelope fa-fw" style={{color: "#000000"}}></i>
                              <b class="text-decoration-none" style={{color: "#000000"}} href="#">hello@beclassy.vn</b>
                          </li>
                      </ul>
                  </div>
